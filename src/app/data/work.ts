export const work = [
  {
    ...
    skills: ['REACT', 'TYPESCRIPT', 'STYLUS', 'STYLED COMPONENTS', 'RTLCSS'],
    screenshots: [
      '/assets/img/past-work/riotgames_riotclient_rtl.jpg',
      '/assets/img/past-work/riotgames_leagueclient_rtl_1.jpg',
      '/assets/img/past-work/riotgames_leagueclient_rtl_2.jpg',
      '/assets/img/past-work/riotgames_leagueclient_rtl_3.jpg',
      '/assets/img/past-work/riotgames_leagueclient_rtl_4.jpg',
      '/assets/img/past-work/riotgames_leagueclient_rtl_5.jpg',
    ],
  },
  {
    ...
    screenshots: [
      '/assets/img/past-work/spinmatic_1.jpg',
      '/assets/img/past-work/spinmatic_2.jpg',
      '/assets/img/past-work/spinmatic_3.jpg',
      // '/assets/img/past-work/spinmatic_4.jpg',
    ],
  },
];
